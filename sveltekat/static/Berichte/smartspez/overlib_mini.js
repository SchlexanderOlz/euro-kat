...
function ol_content_simple(text) {
	if (ocss == CSSCLASS)
		txt =
			...
			' CELLSPACING=0 class="' +
			obgclass +
			'"><TR><TD><TABLE WIDTH=100% BORDER=0 CELLPADDING=2 CELLSPACING=0 class="' +
			ofgclass +
			'"><TR><TD VALIGN=TOP><FONT class="' +
			otextfontclass +
			'">' +
			text +
	...
	if (ocss == CSSSTYLE)
		txt =
			...
			' BORDER=0 CELLPADDING=' +
			oborder +
			' CELLSPACING=0 style="background-color: ' +
			obgcolor +
			';height: ' +
			oheight +
			oheightunit +
			';"><TR><TD><TABLE WIDTH=100% BORDER=0 CELLPADDING=2 CELLSPACING=0 style="color: ' +
			ofgcolor +
			';background-color: ' +
			ofgcolor +
			';height: ' +
			oheight +
			oheightunit +
			';"><TR><TD VALIGN=TOP><FONT style="font-family: ' +
			otextfont +
			';color: ' +
			otextcolor +
			';font-size: ' +
...
function ol_content_caption(text, title, close) {
	...
	if (ocss == CSSCLASS)
		txt =
			...
			' CELLSPACING=0 class="' +
			obgclass +
			'"><TR><TD><TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0><TR><TD><FONT class="' +
			ocaptionfontclass +
			'">' +
			ocapicon +
			title +
			'</FONT></TD>' +
			closing +
			'</TR></TABLE><TABLE WIDTH=100% BORDER=0 CELLPADDING=2 CELLSPACING=0 class="' +
			ofgclass +
			'"><TR><TD VALIGN=TOP><FONT class="' +
			otextfontclass +
			'">' +
	...
	if (ocss == CSSSTYLE)
		txt =
			...
			oheight +
			oheightunit +
			';"><TR><TD><TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0><TR><TD><FONT style="font-family: ' +
			ocaptionfont +
			';color: ' +
			ocapcolor +
			';font-size: ' +
			...
			'</FONT></TD>' +
			closing +
			'</TR></TABLE><TABLE WIDTH=100% BORDER=0 CELLPADDING=2 CELLSPACING=0 style="color: ' +
			ofgcolor +
			';background-color: ' +
			ofgcolor +
			';height: ' +
	...
	if (ocss == CSSOFF)
		txt =
			...
			' ' +
			oheight +
			'><TR><TD><TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0><TR><TD><B><FONT COLOR="' +
			ocapcolor +
			'" FACE="' +
			ocaptionfont +
			'" SIZE="' +
