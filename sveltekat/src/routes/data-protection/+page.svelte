...
<div class="mx-[10%] cursor-default">
    ...
    <p>
        ...
        die Nutzung des Internetauftritts, inklusive seiner Inhalte und der dort angebotenen Leistungen
        nicht erhoben und demnach auch nicht verarbeitet.
    </p>
    <p>
    ...
    <p>
        Mit der nachfolgenden Datenschutzerklärung informiere ich Sie insbesondere über Art, Umfang,
        Zweck, Dauer und Rechtsgrundlage der Verarbeitung personenbezogener Daten, soweit ich entweder
        allein oder gemeinsam mit anderen über die Zwecke und Mittel der Verarbeitung entscheide. Zudem
        informiere ich Sie nachfolgend über die von mir zu Optimierungszwecken sowie zur Steigerung der
        Nutzungsqualität eingesetzten Fremdkomponenten, soweit hierdurch Dritte Daten in wiederum eigener
        Verantwortung verarbeiten.
    </p>
    <h3>I. Informationen über mich als Verantwortlichen</h3>
    <p>Siehe <a href="/imprint">Impressum</a></p>
    ...
    <p>Durch die Nutzung meiner Internetauftritte werden keine personenbezogenen Daten erhoben.</p>
    <p>
        Die Sammlerseiten leben von der Unterstützung durch Sammlerinnen und Sammler aus der ganzen Welt.<br
        />Es ist mir wichtig, mich für jede zugesendete Information, jedes zugesendete Bild zu bedanken,
        indem ich Name und Vorname der Zusenderin/des Zusenders auf der jeweiligen Seite angebe. Diese
        Angabe dient gleichzeitig dem Nachweis über die Bildherkunft. Dieses wende ich jetzt über 10 Jahre
        an und ist für alle Besucherinnen und Besucher meiner Seiten sichtbar.
    </p>
    <p class="inhaltdick">
        Mit der Zusendung einer Information, eines Bildes erklären Sie sich mit der Veröffentlich Ihres
        Namen und Ihres Vornamens einverstanden! Sollten Sie dieses nicht wünschen, so teilen Sie mir
        dieses in der Mail mit
    </p>
    <p class="inhaltdick">Serverdaten</p>
    <p>
    ...
    <p class="inhaltdick">1. Inhalt des Onlineangebotes</p>
    <p>
        ...
        vorsätzliches oder grob fahrlässiges Verschulden vorliegt.<br />Alle Angebote sind freibleibend
        und unverbindlich. Der Autor behält es sich ausdrücklich vor, Teile der Seiten oder das gesamte
        Angebot ohne gesonderte Ankündigung zu verändern, zu ergänzen, zu löschen oder die
        Veröffentlichung zeitweise oder endgültig einzustellen.
    </p>
    <p class="inhaltdick">2. Verweise und Links</p>
    <p>
        ...
        und zumutbar wäre, die Nutzung im Falle rechtswidriger Inhalte zu verhindern.<br />Der Autor
        ...
        distanziert er sich hiermit ausdrücklich von allen Inhalten aller verlinkten /verknüpften Seiten
        sowie den Inhalten der von diesen Seiten weiterführenden Verlinkungen, die nach der Linksetzung
        ...
        Diskussionsforen, Linkverzeichnissen, Mailinglisten und in allen anderen Formen von Datenbanken,
        auf deren Inhalt externe Schreibzugriffe möglich sind. Für illegale, fehlerhafte oder
    ...
    <p class="inhaltdick">3. Urheber- und Kennzeichenrecht</p>
    <p>
        ...
        Videosequenzen und Texte zurückzugreifen.<br />Alle innerhalb des Internetangebotes genannten und
        ...
        Markenzeichen nicht durch Rechte Dritter geschützt sind!<br />Das Copyright für veröffentlichte,
        vom Autor selbst erstellte Objekte bleibt allein beim Autor der Seiten. Eine Vervielfältigung oder
        Verwendung solcher Grafiken, Tondokumente, Videosequenzen und Texte in anderen elektronischen oder
        gedruckten Publikationen ist ohne ausdrückliche Zustimmung des Autors nicht gestattet.
    </p>
    <p class="inhaltdick">4. Rechtswirksamkeit dieses Haftungsausschlusses</p>
    <p>
...
<style>
    div {
        @apply text-surface-900-50-token mb-16;
    }
    a {
        @apply underline;
    }
