...
<div class="mx-[10%] my-8 cursor-default">
	...
	<div class="card w-full mt-4 p-2">
		...
		<div class="text-sm">
			<p>
				ist beständig an der Arbeit mit dem Katalog beteiligt. Mit unermüdlicher Aufopferung ist er
				bemüht Zahlen zu verdrehen, Bilder zu verschieben und den einen oder anderen Link ins
	...
	<div class="card p-2 mt-4">
		<p>
			Da die Unterstützung mit Informationen und Bilder meine kühnsten Erwartungen übertroffen hat,
			setze ich meinen Dank hierfür auf die jeweilige Einzelseite. So kann ich (hoffentlich)
			niemanden übersehen. Jeder einzelne Beitrag ist nützlich, wichtig und des Dankes wert!
		</p>
	</div>

	<div class="text-sm mt-8">
		<p class="underline">Das bisherige Autorenteam des Euro Katalog bestand aus:</p>
		<p class="font-bold mt-2">Olaf Ikels</p>
		<p>Hartplastikfiguren, Fahrzeuge, Luftfahrt, Jahrgangslisten (Spielzeug)</p>
		<p class="font-bold mt-2">Matthias Löwe</p>
		<p>
			Hartplastikfiguren, Beipackzettel, Steckfiguren, Plastikpuzzles, Bälger, Kugelfiguren,
			Eisenbahnen, Kapselfiguren
		</p>
		<p class="font-bold mt-2">Manfred Schreiner</p>
		<p>Metallfiguren</p>

		<p class=" mt-2">und bis 2001 <span class="font-bold">Conny Pay.</span></p>
		<p class="mt-3">
			Sie haben über Jahre hinweg das umfangreichste Informationsangebot für Sammler der
			Ü-Ei-Inhalte im Internet zusammengetragen. Das einzigartige sind die Vielzahl von
			Informationen zu den einzelnen Sammelobjekte. Insbesondere die reichhaltigen Informationen zur
			Differenzierung der Figuren und Objekte zwischen ihrem Erscheinen in Deutschland und dem
			Ausland.
		</p>
	</div>
</div>
