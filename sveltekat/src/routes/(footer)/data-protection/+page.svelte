...
<div class="mx-[10%] cursor-default">
	...
	<p>
		...
		Welt.<br />Es ist mir wichtig, mich für jede zugesendete Information, jedes zugesendete Bild zu
		bedanken, indem ich Name und Vorname der Zusenderin/des Zusenders auf der jeweiligen Seite
		angebe. Diese Angabe dient gleichzeitig dem Nachweis über die Bildherkunft. Dieses wende ich
		jetzt über 10 Jahre an und ist für alle Besucherinnen und Besucher meiner Seiten sichtbar.
	</p>
	<p class="inhaltdick">
	...
	<p>
		...
		gewechselt haben (Referrer URL), die Website(s) unseres Internetauftritts, die Sie besuchen,
		Datum und Uhrzeit des jeweiligen Zugriffs sowie die IP-Adresse des Internetanschlusses, von dem
	...
	<p>
		Die Daten werden spätestens nach sieben Tage wieder gelöscht, soweit keine weitere Aufbewahrung
		zu Beweiszwecken erforderlich ist. Andernfalls sind die Daten bis zur endgültigen Klärung eines
	...
	<p>
		...
		nachweislich vorsätzliches oder grob fahrlässiges Verschulden vorliegt.<br />Alle Angebote sind
		freibleibend und unverbindlich. Der Autor behält es sich ausdrücklich vor, Teile der Seiten oder
	...
	<p>
		...
		möglich und zumutbar wäre, die Nutzung im Falle rechtswidriger Inhalte zu verhindern.<br />Der
		...
		/verknüpften Seiten sowie den Inhalten der von diesen Seiten weiterführenden Verlinkungen, die
	...
	<p>
		...
		und ggf. durch Dritte geschützten Marken- und Warenzeichen unterliegen uneingeschränkt den
		Bestimmungen des jeweils gültigen Kennzeichenrechts und den Besitzrechten der jeweiligen
		eingetragenen Eigentümer. Allein aufgrund der bloßen Nennung ist nicht der Schluss zu ziehen,
		dass Markenzeichen nicht durch Rechte Dritter geschützt sind!<br />Das Copyright für
		...
		anderen elektronischen oder gedruckten Publikationen ist ohne ausdrückliche Zustimmung des
