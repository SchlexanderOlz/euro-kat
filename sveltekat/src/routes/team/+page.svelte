...
<div class="mx-[10%] my-8 cursor-default">
    ...
    <div class="text-sm mt-8">
        ...
        <p class="mt-3">
            Sie haben über Jahre hinweg das umfangreichste Informationsangebot für Sammler der Ü-Ei-Inhalte
            im Internet zusammengetragen. Das einzigartige sind die Vielzahl von Informationen zu den
            einzelnen Sammelobjekte. Insbesondere die reichhaltigen Informationen zur Differenzierung der
            Figuren und Objekte zwischen ihrem Erscheinen in Deutschland und dem Ausland.
        </p>
    </div>
